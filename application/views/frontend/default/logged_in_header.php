            ...
            <div class="col">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <a href="<?php echo site_url(''); ?>" class="navbar-brand" href="#">
                        <img src="<?php echo base_url() . 'uploads/system/logo-dark.png'; ?>" alt="" height="100" width="220">
                    </a>
                    ...
                    <form class="inline-form" action="<?php echo site_url('home/search'); ?>" method="get" style="width: 20%;">
                    ...
                    <div class="user-box menu-icon-box">
                        ...
                        <div class="dropdown user-dropdown corner-triangle top-right">
                            <ul class="user-dropdown-menu">
                                ...
                                <li  class="user-dropdown-menu-item"><a id="header" href="<?php echo site_url('home'); ?>"><?php echo get_phrase('Home'); ?></a></li>
								<li  class="user-dropdown-menu-item"><a id="header"  href="<?php echo site_url('home/about_us'); ?>"><?php echo get_phrase('About us'); ?></a></li>
                    
								<li  class="user-dropdown-menu-item"><a id="header"  href="<?php echo site_url('home/news'); ?>"><?php echo get_phrase('News'); ?></a></li>
								<li  class="user-dropdown-menu-item"><a id="header"  href="<?php echo site_url('#course'); ?>"><?php echo get_phrase('Course'); ?></a></li>
								<li  class="user-dropdown-menu-item"><a id="header"  href="<?php echo site_url('#product'); ?>"><?php echo get_phrase('Product'); ?></a></li>
								<li  class="user-dropdown-menu-item"><a id="header" href="<?php echo site_url('home/product'); ?>"><?php echo get_phrase('gallery'); ?></a></li>

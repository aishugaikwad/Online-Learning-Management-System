...
<section class="course-carousel-area" id="course">
    <div class="container-lg">
        <div class="row">
            <div class="col">
                <h2 class="course-carousel-title"><?php echo get_phrase('our_courses'); ?></h2>
                    ...
                    <div class="course-box-wrap">
                        <a href="<?php echo site_url('home/course/'.slugify($top_course['title']).'/'.$top_course['id']); ?>" class="has-popover">
                            <div class="course-box">
                                ...
                                <div class="course-image" width="40px" height="100px">
...
<!-- <section class="course-carousel-area" id="product">
    <div class="container-lg">
        <div class="row">
            <div class="col">
                <h2 class="course-carousel-title">Our Products</h2>
                <div class="course-carousel">
                     <div class="course-box">
                        <div class="course-image">
                        <img src="assets/backend/images/hydroponic.jpg" alt="" class="img-fluid" >
                        </div>
                        <div class="course-details">
                        sjdsfjif
                        </div>  
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="container-lg">
        <div class="row">
            <div class="col">
  <h2 class="course-carousel-title"><?php echo get_phrase('our_products'); ?></h2>
  <!-- The slideshow -->
  <div class="container carousel-inner no-padding">
    <div class="carousel-item active">
      <div class="col-xs-3 col-sm-3 col-md-3">
        <img src="assets/backend/images/hydroponic.jpg">
      </div>    
      <div class="col-xs-3 col-sm-3 col-md-3">
        <img src="assets/backend/images/hydroponic.jpg">
      </div>   

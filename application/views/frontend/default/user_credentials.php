                    ...
                    <div class="user-dashboard-content">
                        ...
                        <form action="<?php echo site_url('home/update_profile/update_credentials'); ?>" method="post">
                            <div class="content-box">
                                ...
                                <div class="email-group">
                                    <div class="form-group">
                                        <label for="contact-no"><?php echo get_phrase('contact_no'); ?>:</label>
                                        <input type="number" class="form-control" name = "contact_no" id="contact-no" placeholder="<?php echo get_phrase('contact_no'); ?>" value="<?php echo $user_details['contact_no']; ?>">
                                    </div>
                                </div>

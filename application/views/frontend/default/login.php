                      ...
                      <form action="<?php echo site_url('login/register'); ?>" method="post">
                          <div class="content-box">
                              <div class="basic-group">
                                  ...
                                  <div class="form-group">
                                      <label for="contact-no"><span class="input-field-icon"><i class="fas fa-envelope"></i></span> <?php echo get_phrase('contact_no'); ?>:</label>
                                      <input type="number" class="form-control" name = "contact_no" id="contact-no" placeholder="<?php echo get_phrase('contact_no'); ?>" value="" required>
                                  </div>
                                  <div class="form-group">

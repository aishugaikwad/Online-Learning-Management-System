        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/frontend_settings/frontend_update'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="product"><?php echo get_phrase('product'); ?></label>
                        <textarea name="product" id = "product" class="form-control" rows="5"><?php echo get_frontend_settings('product'); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="news"><?php echo get_phrase('news'); ?></label>
                        <textarea name="news" id = "news" class="form-control" rows="5"><?php echo get_frontend_settings('news'); ?></textarea>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
  $(document).ready(function () {
    initSummerNote(['#about_us','#product','#news', '#terms_and_condition', '#privacy_policy']);
  });
</script>
